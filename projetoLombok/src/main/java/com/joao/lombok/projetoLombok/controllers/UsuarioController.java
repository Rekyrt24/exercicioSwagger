package com.joao.lombok.projetoLombok.controllers;
...
import com.joao.lombok.projetoLombok.services.UsuarioService;
...
public class UsuarioController {
	...
	@GetMapping("/{id}")
	@Operation(summary = "Localiza usuário poi ID")
	...
	@GetMapping("/")
	@Operation(summary = "Apresente todos os usuários")
